...
| Counter publication | Native memory ordering | Linux x86_64, Linux AArch64, macOS AArch64, Windows x86_64 | `tests/counters_reader_publication.rs` in the native test matrix | Covered | The delivered revision passed publication tests on native x86_64 and AArch64 in GitHub Actions run 30394389866. |
